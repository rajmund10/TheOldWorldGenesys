	...
	<BasicItemSheet show-effects-tab>
			...
			<section class="overview">
				...
				<section class="stats">
					...
					<ul>
						...
						<li>
							<strong><Localized label="Genesys.Archetype.StartingCorruption" />:</strong> {{ system.corruptionThreshold }} + <Localized label="Genesys.Characteristics.Presence" />
						</li>
						<li>
		...
		<template v-slot:data>
			<section class="data-grid">
				...
				<div class="row">
					<label><Localized label="Genesys.Archetype.StartingCorruption" /></label>
					<input type="number" name="system.corruptionThreshold" :value="system.corruptionThreshold" />
				</div>
