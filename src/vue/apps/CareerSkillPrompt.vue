...
const requiredSelections = computed(() => Math.min(CONFIG.genesys.settings.freeCareerSkillRanks, context.skills.length));
const remaining = computed(() => requiredSelections.value - selectedSkillIDs.value.length);
