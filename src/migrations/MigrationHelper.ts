...
import { migrate_RepairLegacyChatDiceImages } from '@/migrations/3-repair-legacy-chat-dice-images';
...
const migrationScripts: Array<(migrationId: number) => Promise<MigrationStatus>> = [migrate_UseUuidForVehicles, migrate_ActorOnlyOnceInCrew, migrate_RepairLegacyChatDiceImages];
